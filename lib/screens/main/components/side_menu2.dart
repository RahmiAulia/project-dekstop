...
class SideMenuNew extends StatefulWidget {
  ...
  @override
  State<SideMenuNew> createState() => _SideMenuNewState();
}

class _SideMenuNewState extends State<SideMenuNew> {
  String status = '';
  @override
  void initState() {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DrawerList(
              title: "Transaksi",
              svgSrc: "assets/icons/bx-money.svg",
              press: () {
            ...
            DrawerList(
              title: "Member",
              svgSrc: "assets/icons/bxs-user.svg",
              press: () {
                widget.navigatorKey.currentState!.push(
            ...
            //       );
            //     } else {
            //       // Tidak melakukan apa pun jika pengguna bukan admin
            //     }
            //   },
            // ),
            // DrawerList(
